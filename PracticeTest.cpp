...
TEST(PracticeTest, double_pal)
{
    Practice obj;
    bool actual = obj.isPalindrome("racecarracecaR");
    ASSERT_TRUE(actual);
}
...
//negatives
TEST(PracticeTest, sort_happy_neg)
{
  Practice obj;
  int x, y, z;
  x = -3;
...
TEST(PracticeTest, sort_middle_right_neg)
{
  Practice obj;
  int x, y, z;
  x = -3;
...
TEST(PracticeTest, sort_middle_left_neg)
{
  Practice obj;
  int x, y, z;
  x = -2;
...
TEST(PracticeTest, sort_outside_neg)
{
  Practice obj;
  int x, y, z;
  x = -1;
